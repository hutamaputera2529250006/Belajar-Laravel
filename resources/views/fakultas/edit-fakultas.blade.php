    ...
    <div>
        ...
        <form action="/fakultas/{{ $fakultas->id }}" method="post">
            ...
            <div class="form-group">
                <input name= "name_fakultas" type="text" value="{{ $fakultas->name }}" {{-- value ini agar saat klik edit langsung muncul data --}}
                    class="form-control" placeholder="Nama Fakultas">
            </div>

            <div class="form-group">
                <input name= "name_dekan" type="text" value="{{ $fakultas->dekan }}" class="form-control"
